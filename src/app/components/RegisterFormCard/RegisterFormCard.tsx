    ...
    return (
        <div className="w-[500px] h-full max-h-[750px] rounded-2xl pt-12 bg-[#EEEDED] shadow-xl flex flex-col items-center">
            <Image
                ...
                alt="Petzzz logo"
            />
            <p className={`${poppinsTextFont.className} text-shadow text-sm flex gap-2 mt-8 text-left me-28 mb-2`}>
                {ALREADY_HAVE_LOGIN_TEXT}
                <strong className="font-semibold translate-x-[-10%]">login</strong>
            </p>
            <RegisterForm />
            <p className={`${poppinsTextFont.className} text-shadow text-sm flex gap-2 mt-4 text-left me-36`}>
